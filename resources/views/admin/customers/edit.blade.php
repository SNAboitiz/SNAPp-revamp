<flux:modal name="edit-customer" class="md:w-96">
    <form data-base-action="{{ route('customers.update', ['customer' => ':customer_id']) }}" method="POST"
        id="edit-customer" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <flux:field>
            ...
            <flux:input name="edit_customer_number" placeholder="Enter oracle customer ID" />
