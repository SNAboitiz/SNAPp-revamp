...
var yo = (i, t, e) =>
    t in i
        ? _o(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (i[t] = e);
var M = (i, t, e) => yo(i, typeof t != "symbol" ? t + "" : t, e);
/*!
 * @kurkle/color v0.3.4
...
const it = {
    ...
    _i = [..."0123456789ABCDEF"],
    vo = (i) => _i[i & 15],
    Mo = (i) => _i[(i & 240) >> 4] + _i[i & 15],
    ke = (i) => (i & 240) >> 4 === (i & 15),
    ko = (i) => ke(i.r) && ke(i.g) && ke(i.b) && ke(i.a);
function wo(i) {
    var t = i.length,
        e;
    return (
...
let we;
function zo(i) {
    we || ((we = Io()), (we.transparent = [0, 0, 0, 0]));
...
function Vo(i) {
    ...
    if (t) {
        ...
        return (
            ...
            (n = +t[3]),
            (o = +t[5]),
            (s = 255 & (t[2] ? ee(s) : xt(s, 0, 255))),
            (n = 255 & (t[4] ? ee(n) : xt(n, 0, 255))),
            (o = 255 & (t[6] ? ee(o) : xt(o, 0, 255))),
            { r: s, g: n, b: o, a: e }
        );
    }
}
...
function No(i, t, e) {
    const s = Ht(gt(i.r)),
        ...
        o = Ht(gt(i.b));
    return {
        r: Mt(ai(s + e * (Ht(gt(t.r)) - s))),
        g: Mt(ai(n + e * (Ht(gt(t.g)) - n))),
        b: Mt(ai(o + e * (Ht(gt(t.b)) - o))),
        a: i.a + e * (t.a - i.a),
    };
}
function Se(i, t, e) {
    ...
    return (
        Array.isArray(i)
            ? i.length >= 3 &&
              ...
              i.length > 3 && (t.a = Mt(i[3])))
            : ((t = kn(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = Mt(t.a))),
        t
    );
}
function Ho(i) {
    return i.charAt(0) === "r" ? Vo(i) : Ro(i);
}
class ue {
    constructor(t) {
...
function R(i, t, e, s) {
    let n, o, a;
    if (V(i)) for (o = i.length, n = 0; n < o; n++) t.call(e, i[n], n);
    else if (T(i))
...
function kt(i, t) {
    return (is[t] || (is[t] = Ko(t)))(i);
}
function Bi(i) {
    return i.charAt(0).toUpperCase() + i.slice(1);
}
const ge = (i) => typeof i < "u",
    wt = (i) => typeof i == "function",
    ss = (i, t) => {
...
function Dn(i, t) {
    ...
    return (o < -0.5 * z && (o += I), { angle: o, distance: n });
}
function yi(i, t) {
...
const Cn = ["push", "pop", "shift", "splice", "unshift"];
function oa(i, t) {
    if (i._chartjs) {
...
const Pe = (i) => i === 0 || i === 1,
    ls = (i, t, e) =>
        -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * I) / e)),
    cs = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * I) / e) + 1,
    ce = {
        linear: (i) => i,
        easeInQuad: (i) => i * i,
        easeOutQuad: (i) => -i * (i - 2),
        ...
        easeInOutElastic(i) {
            return Pe(i)
                ? i
                : i < 0.5
                  ? 0.5 * ls(i * 2, 0.1125, 0.45)
                  : 0.5 + 0.5 * cs(i * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(i) {
        ...
        easeInOutBounce: (i) =>
            i < 0.5
                ? ce.easeInBounce(i * 2) * 0.5
                : ce.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
    };
function Hi(i) {
...
const la = ["x", "y", "borderWidth", "radius", "tension"],
    ca = ["color", "borderColor", "backgroundColor"];
function ha(i) {
    (i.set("animation", {
        delay: void 0,
        duration: 1e3,
        ...
        i.set("animations", {
            colors: { type: "color", properties: ca },
            numbers: { type: "number", properties: la },
        }),
...
const En = {
    ...
    numeric(i, t, e) {
        ...
        if (e.length > 1) {
            ...
            ((c < 1e-4 || c > 1e15) && (n = "scientific"), (o = fa(i, e)));
        }
        const a = _t(Math.abs(o)),
...
class pa {
    constructor(t, e) {
        ((this.animation = void 0),
            ...
            (this.hover = {}),
            (this.hoverBackgroundColor = (s, n) => ri(n.backgroundColor)),
            (this.hoverBorderColor = (s, n) => ri(n.borderColor)),
            (this.hoverColor = (s, n) => ri(n.color)),
            (this.indexAxis = "x"),
            (this.interaction = {
                mode: "nearest",
                intersect: !0,
...
function ba(i, t, e, s) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
        if (((d = e[l]), d != null && !V(d))) a = qe(i, n, o, a, d);
        else if (V(d))
...
function Fn(i, t, e, s, n) {
    ...
    if (!(isNaN(p) || p <= 0)) {
        switch ((i.beginPath(), f)) {
            default:
                (n ? i.ellipse(e, s, n / 2, p, 0, 0, I) : i.arc(e, s, p, 0, I),
                    i.closePath());
                break;
            case "triangle":
                ((h = n ? n / 2 : p),
            ...
            case "rectRounded":
                ((c = p * 0.516),
                    ...
                    (r = Math.sin(m + Ct) * l),
                    (u = Math.sin(m + Ct) * (n ? n / 2 - c : l)),
                    i.arc(e - d, s - r, c, m - z, m - j),
                    i.arc(e + u, s - a, c, m - j, m),
                    i.arc(e + d, s + r, c, m, m + j),
                    i.arc(e - u, s + a, c, m + j, m + z),
                    i.closePath());
                break;
            case "rect":
                if (!g) {
...
function Bt(i, t, e, s, n, o = {}) {
    ...
    let l, c;
    for (i.save(), i.font = n.string, ya(i, o), l = 0; l < a.length; ++l)
        ((c = a[l]),
            o.backdrop && Ma(i, o.backdrop),
            r &&
...
function me(i, t) {
    ...
    (i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * z, z, !0),
        i.lineTo(e, s + o - a.bottomLeft),
        i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, z, j, !0),
        ...
        i.arc(e + n - a.topRight, s + a.topRight, a.topRight, 0, -j, !0),
...
function Oa(i, t, e) {
    ...
    let r = s[t];
    return (
        wt(r) && a.isScriptable(t) && (r = Aa(t, r, i, e)),
        V(r) && r.length && (r = Ta(t, r, i, a.isIndexable)),
        Yi(t, r) && (r = Xt(r, n, o && o[t], a)),
        r
    );
}
function Aa(i, t, e, s) {
...
const La = (i, t) => (i === !0 ? t : typeof i == "string" ? kt(t, i) : void 0);
...
function Xi(i, t, e, s) {
    const n = t._rootScopes,
        o = Vn(t._fallback, e, s),
        a = [...i, ...n],
        r = new Set();
    r.add(s);
    let l = fs(r, a, e, o || e, s);
    return l === null ||
        (typeof o < "u" && o !== e && ((l = fs(r, a, o, l, s)), l === null))
        ? !1
        : $i(Array.from(r), [""], n, o, () => Ea(t, e, s));
}
...
function Nn(i, t, e, s) {
    ...
    let r, l, c, h;
    for (r = 0, l = s; r < l; ++r)
        ((c = r + e), (h = t[c]), (a[r] = { r: n.parse(kt(h, o), c) }));
    return a;
}
const za = Number.EPSILON || 1e-14,
    ...
    for (e = 0, s = i.length; e < s; ++e)
        ((a = o),
            ...
            o &&
                ((n = i[e]),
                a &&
                    ((n.cp1x = De(n.cp1x, t.left, t.right)),
                    (n.cp1y = De(n.cp1y, t.top, t.bottom))),
                r &&
                    ((n.cp2x = De(n.cp2x, t.left, t.right)),
    ...
    if (t === void 0 || e === void 0) {
        ...
        if (!o) ((t = i.clientWidth), (e = i.clientHeight));
            ...
            ((t = a.width - c.width - l.width),
                ...
                (s = Ge(r.maxWidth, o, "clientWidth")),
                (n = Ge(r.maxHeight, o, "clientHeight")));
        }
    }
...
function qa(i, t, e, s) {
    const n = si(i),
        o = It(n, "margin"),
        a = Ge(n.maxWidth, i, "clientWidth") || Ke,
        r = Ge(n.maxHeight, i, "clientHeight") || Ke,
        l = Ka(i, t, e);
    let { width: c, height: h } = l;
    if (n.boxSizing === "content-box") {
        const u = It(n, "border", "width"),
            f = It(n, "padding");
    ...
    return (
        ...
        (c = Ce(Math.min(c, a, l.maxWidth))),
        (h = Ce(Math.min(h, r, l.maxHeight))),
        c && !h && (h = Ce(c / 2)),
        (t !== void 0 || e !== void 0) &&
            s &&
            l.height &&
            h > l.height &&
            ((h = l.height), (c = Ce(Math.floor(h * s)))),
        { width: c, height: h }
    );
}
function ps(i, t, e) {
...
function Yn(i) {
    return i === "angle"
        ? { between: pe, compare: ea, normalize: et }
...
function Xn(i, t, e) {
    ...
    const { property: s, start: n, end: o } = e,
        ...
        { start: h, end: d, loop: u, style: f } = er(i, t, e),
        g = [];
    let p = !1,
        m = null,
        b,
    ...
    return (
        m !== null &&
            g.push(bs({ start: m, end: d, loop: u, count: a, style: f })),
        g
    );
}
function Un(i, t) {
...
function nr(i, t) {
    ...
    if (!n) return [];
    const o = !!i._loop,
        { start: a, end: r } = ir(e, n, o, s);
    if (s === !0) return xs(i, [{ start: a, end: r, loop: o }], e, t);
    const l = r < a ? r + n : r,
        c = !!i._fullLoop && a === 0 && r === n - 1;
    return xs(i, sr(e, a, l, c), e, t);
}
function xs(i, t, e, s) {
...
class hr {
    constructor(t, e, s, n) {
        ...
        const a = ie([t.from, o, n]);
        ((this._active = !0),
            (this._fn = t.fn || cr[t.type || typeof a]),
...
class qn {
    ...
    configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach((n) => {
            ...
            ((V(o.properties) && o.properties) || [n]).forEach((r) => {
    ...
    _animateOptions(t, e) {
        ...
        return (
            s.$shared &&
                dr(t.options.$animations, s).then(
                    () => {
                        t.options = s;
                    },
                    () => {},
...
function ws(i, t) {
    ...
    for (let f = 0; f < d; ++f) {
        ...
        ((u = b[c] = xr(n, h, p)),
            (u[r] = m),
            (u._top = ks(u, a, !0, s.type)),
            (u._bottom = ks(u, a, !1, s.type)));
...
const di = (i) => i === "reset" || i === "none",
    ...
    vr = (i, t, e) =>
        i && !t.hidden && t._stacked && { keys: Gn(e, !0), values: null };
class ot {
    constructor(t, e) {
        ((this.chart = t),
            (this._ctx = t.ctx),
    ...
    linkScales() {
        const t = this.chart,
            ...
            a = (e.yAxisID = D(s.yAxisID, hi(t, "y"))),
            r = (e.rAxisID = D(s.rAxisID, hi(t, "r"))),
            l = e.indexAxis,
    ...
    _dataCheck() {
        ...
        if (T(e)) {
            ...
            (e && Object.isExtensible(e) && oa(e, this),
                (this._syncList = []),
                (this._data = e));
        }
    }
    ...
    buildOrUpdateElements(t) {
        ...
        ((e._stacked = ci(e.vScale, e)),
            e.stack !== s.stack && ((n = !0), Gt(e), (e.stack = s.stack)),
            this._resyncElements(t),
            (n || o !== e._stacked) &&
                (ws(this, e._parsed), (e._stacked = ci(e.vScale, e))));
    }
    configure() {
    ...
    parseObjectData(t, e, s, n) {
        ...
        for (h = 0, d = n; h < d; ++h)
            ((u = h + s),
                (f = e[u]),
                (c[h] = { x: o.parse(kt(f, r), u), y: a.parse(kt(f, l), u) }));
        return c;
    }
    getParsed(t) {
    ...
    applyStack(t, e, s) {
        const n = this.chart,
            o = this._cachedMeta,
            a = e[t.axis],
            r = { keys: Gn(n, !0), values: e._stacks[t.axis]._visualValues };
        return Ms(r, a, o.index, { mode: s });
    }
    updateRangeFromParsed(t, e, s, n) {
        const o = s[e.axis];
        let a = o === null ? NaN : o;
        const r = n && s._stacks[e.axis];
        (n && r && ((n.values = r), (a = Ms(n, o, this._cachedMeta.index))),
    ...
    _update(t) {
        ...
        (this.update(t || "default"),
            (e._clip = gr(
                D(
                    this.options.clip,
                    fr(e.xScale, e.yScale, this.getMaxOverflow()),
                ),
            )));
    }
    update(t) {}
    ...
    getContext(t, e, s) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
            ...
            ((o = a.$context || (a.$context = yr(this.getContext(), t, a))),
            ...
            ((o =
                this.$context ||
                (this.$context = _r(this.chart.getContext(), this.index))),
                (o.dataset = n),
    ...
    _resolveElementOptions(t, e = "default", s) {
        ...
        return (
            p.$shared && ((p.$shared = l), (o[a] = Object.freeze(Ss(p, l)))),
            p
        );
    }
...
(M(ot, "defaults", {}),
    M(ot, "datasetElementType", null),
    M(ot, "dataElementType", null));
function Mr(i, t) {
    if (!i._cache.$bar) {
...
function kr(i) {
    ...
    const l = () => {
        a === 32767 ||
            a === -32768 ||
            (ge(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
    };
...
function Zn(i, t, e, s) {
    return (V(i) ? Pr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t);
}
function Ps(i, t, e, s) {
    const n = i.iScale,
        o = i.vScale,
...
function Ds(i, t, e, s) {
    return (s ? ((i = Ar(i, t, e)), (i = Cs(i, e, t))) : (i = Cs(i, t, e)), i);
}
function Ar(i, t, e) {
...
function Tr(i, { inflateAmount: t }, e) {
...
class ze extends ot {
    ...
    parseObjectData(t, e, s, n) {
        ...
        for (u = s, f = s + n; u < f; ++u)
            ((p = e[u]),
                (g = {}),
                (g[o.axis] = o.parse(kt(p, c), u)),
                d.push(Zn(kt(p, h), g, a, u)));
        return d;
    }
    updateRangeFromParsed(t, e, s, n) {
        ...
        for (let f = e; f < e + s; f++) {
            const g = this.getParsed(f),
                ...
                x = {
                    ...
                    base: p.base,
                    enableBorderRadius:
                        !b || ui(g._custom) || a === b._top || a === b._bottom,
                    x: c ? p.head : m.center,
                    y: c ? m.center : p.head,
    ...
    _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
            const c = o ? this._getStackCount(t) : e.stackCount,
                h = n.barThickness === "flex" ? Sr(t, e, n, c) : wr(t, e, n, c),
...
function Lr(i, t, e) {
    ...
    if (t < I) {
        const r = i,
            ...
            u = Math.sin(l),
            f = (v, y, _) =>
                pe(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e),
            g = (v, y, _) =>
                pe(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e),
            p = f(0, c, d),
            m = f(j, h, u),
            b = g(z, c, d),
            x = g(z + j, h, u);
...
class Et extends ot {
    ...
    update(t) {
        const e = this.chart,
            ...
            l = Math.min($o(this.options.cutout, r), 1),
            c = this._getRingWeight(this.index),
            { circumference: h, rotation: d } = this._getRotationExtents(),
            { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = Lr(d, h, l),
            m = (s.width - a) / u,
            b = (s.height - a) / f,
            x = Math.max(Math.min(m, b) / 2, 0),
            v = wn(this.options.radius, x),
            y = Math.max(v * l, 0),
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = ve(e._parsed[t], s.options.locale);
...
class de extends ot {
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = ve(e._parsed[t].r, s.options.locale);
        return { label: n[t] || "", value: o };
    }
    parseObjectData(t, e, s, n) {
...
class Ne extends ot {
    ...
    updateElements(t, e, s, n) {
        const o = n === "reset",
            ...
            b = Yt(p) ? p : Number.POSITIVE_INFINITY,
...
function Fr(i, t, e, s) {
    ...
    if (r && t === r.axis && t !== "r" && a && o.length) {
        const c = r._reversePixels ? sa : mt;
        if (s) {
            if (n._sharedOptions) {
                const h = o[0],
...
function zr(i, t, e, s) {
    ...
    function o(a, r, l) {
        const { startAngle: c, endAngle: h } = a.getProps(
            ...
            { angle: d } = Dn(a, { x: t.x, y: t.y });
        pe(d, c, h) && n.push({ element: a, datasetIndex: r, index: l });
    }
    return (ni(i, e, t, o), n);
}
    ...
    modes: {
        index(i, t, e, s) {
            const n = Lt(t, i),
                ...
                r = e.intersect ? fi(i, n, o, s, a) : gi(i, n, o, !1, s, a),
                l = [];
            return r.length
...
function Ls(i, t, e, s) {
    ...
    for (const r of i) {
        ...
        if (r.horizontal) {
            const d = t.w * h,
                u = c.size || l.height;
            (ge(c.start) && (a = c.start),
                l.fullSize
                    ? Ae(l, n.left, a, e.outerWidth - n.right - n.left, u)
                    : Ae(l, t.left + c.placed, a, d, u),
                (c.start = a),
                (c.placed += d),
                (a = l.bottom));
        } else {
            const d = t.h * h,
                u = c.size || l.width;
            (ge(c.start) && (o = c.start),
                l.fullSize
                    ? Ae(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
                    : Ae(l, o, t.top + c.placed, u, d),
                (c.start = o),
                (c.placed += d),
                (o = l.right));
        }
...
class ol extends to {
    ...
    removeEventListener(t, e) {
        const s = t.$proxies || (t.$proxies = {}),
            n = s[e];
        if (!n) return;
        ((({ attach: pi, detach: pi, resize: pi })[e] || Zr)(t, e, n),
            (s[e] = void 0));
    }
    getDevicePixelRatio() {
...
const fl = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
    Fs = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e),
    Is = (i, t) => Math.min(t || i, i);
function zs(i, t) {
    const e = [],
        s = i.length / t,
        n = i.length;
...
function ml(i, t) {
    return St(i, { scale: t, type: "scale" });
}
function bl(i, t, e) {
    return St(i, { tick: e, index: t, type: "tick" });
}
function xl(i, t, e) {
    let s = Ni(i);
...
class Vt extends at {
    ...
    getUserBounds() {
        ...
        return (
            ...
            { min: tt(t, s), max: tt(e, n), minDefined: N(t), maxDefined: N(e) }
        );
    }
    getMinMax(t) {
        let {
    ...
    calculateLabelRotation() {
        const t = this.options,
            e = t.ticks,
            s = Is(this.ticks.length, t.ticks.maxTicksLimit),
            n = e.minRotation || 0,
            o = e.maxRotation;
        let a = n,
            r,
    ...
    fit() {
        ...
        if (a) {
            ...
            if (
                (r
                    ? ((t.width = this.maxWidth), (t.height = Qt(o) + l))
                    : ((t.height = this.maxHeight), (t.width = Qt(o) + l)),
    ...
    getPixelForDecimal(t) {
        ...
        return ia(this._alignToPixels ? Ot(this.chart, e, 0) : e);
    }
    ...
    _computeGridLineItems(t) {
        ...
        const Q = D(n.ticks.maxTicksLimit, d),
        ...
        for (v = 0; v < d; v += E) {
            const B = this.getContext(v),
                ...
                Pt = H.tickColor,
                qt = H.tickBorderDash || [],
                Dt = H.tickBorderDashOffset;
            ((y = gl(this, v, l)),
                y !== void 0 &&
                    ((_ = Ot(s, y, U)),
                    c ? (k = S = C = L = _) : (w = P = O = X = _),
                    f.push({
                        tx1: k,
                        ty1: w,
                        tx2: S,
                ...
                ? ((_ = S),
                  ...
                  n === "top"
                      ? c === "near" || p !== 0
                          ? (L = -O * C + C / 2)
                          : c === "center"
                            ? (L = -Q.highest.height / 2 - B * C + C)
                            : (L = -Q.highest.height + C / 2)
                      : c === "near" || p !== 0
                        ? (L = C / 2)
                        : c === "center"
                          ? (L = Q.highest.height / 2 - B * C)
                          : (L = Q.highest.height - O * C),
                  d && (L *= -1),
                  p !== 0 &&
                      !E.showLabelBackdrop &&
                      (_ += (C / 2) * Math.sin(p)))
    ...
    drawTitle() {
        ...
        e === "bottom" || e === "center" || T(e)
            ? ((l += a.bottom),
              V(s.text) && (l += o.lineHeight * (s.text.length - 1)))
            : (l += a.top);
        const {
            titleX: c,
            titleY: h,
...
class Le {
    ...
    unregister(t) {
        const e = this.items,
            ...
            n = this.scope;
        (s in e && delete e[s],
            n && s in W[n] && (delete W[n][s], this.override && delete zt[s]));
    }
}
function yl(i, t, e) {
    const s = fe(Object.create(null), [
        e ? W.get(e) : {},
        W.get(t),
        i.defaults,
    ]);
...
class kl {
    constructor() {
        ((this.controllers = new Le(ot, "datasets", !0)),
            (this.elements = new Le(at, "elements")),
            (this.plugins = new Le(Object, "plugins")),
            (this.scales = new Le(Vt, "scales")),
...
function Dl(i, { plugins: t, localIds: e }, s, n) {
    ...
    for (const r of t) {
        ...
        c !== null &&
            o.push({
                plugin: r,
                options: Cl(i.config, { plugin: r, local: e[l] }, c, a),
            });
    }
    return o;
}
...
function Rl(i, t) {
    ...
    return (
        Object.keys(s).forEach((a) => {
            ...
            const l = Si(a, r, Ll(a, i), W.scales[r.type]),
                c = Al(l, n),
                h = e.scales || {};
            o[a] = re(Object.create(null), [{ axis: l }, r, h[l], h[c]]);
        }),
        i.data.datasets.forEach((a) => {
            const r = a.type || i.type,
                l = a.indexAxis || wi(r, t),
                h = (zt[r] || {}).scales || {};
            Object.keys(h).forEach((d) => {
                const u = Ol(d, l),
                    f = a[u + "AxisID"] || u;
                ((o[f] = o[f] || Object.create(null)),
                    re(o[f], [{ axis: u }, s[f], h[d]]));
            });
        }),
        Object.keys(o).forEach((a) => {
            const r = o[a];
            re(r, [W.scales[r.type], W.scale]);
        }),
        o
    );
}
function so(i) {
    ...
    ((t.plugins = D(t.plugins, {})), (t.scales = Rl(i, t)));
}
function no(i) {
    return (
        (i = i || {}),
...
class Fl {
    ...
    getOptionScopes(t, e, s) {
        ...
        e.forEach((h) => {
            (t && (l.add(t), h.forEach((d) => te(l, t, d))),
                ...
                h.forEach((d) => te(l, zt[o] || {}, d)),
                h.forEach((d) => te(l, W, d)),
                h.forEach((d) => te(l, vi, d)));
        });
    ...
    chartOptionScopes() {
        ...
        return [t, zt[e] || {}, W.datasets[e] || {}, { type: e }, W, vi];
    }
...
const Il = (i) => T(i) && Object.getOwnPropertyNames(i).some((t) => wt(i[t]));
function zl(i, t) {
...
class ct {
    ...
    constructor(t, e) {
        ...
        ((this.platform = new (s.platform || al(n))()),
        ...
        if (
            ...
            (this.scales = {}),
            (this._plugins = new wl()),
            (this.$proxies = {}),
            (this._hiddenIndices = {}),
            (this.attached = !1),
            (this._animationsDisabled = void 0),
            (this.$context = void 0),
            (this._doResize = aa((d) => this.update(d), a.resizeDelay || 0)),
            (this._dataChanges = []),
            (je[this.id] = this),
            !r || !l)
        ) {
        ...
        (ut.listen(this, "complete", Ys),
            ut.listen(this, "progress", Wl),
            this._initialize(),
    ...
    _initialize() {
        return (
            ...
            this.options.responsive
                ? this.resize()
                : ps(this, this.options.devicePixelRatio),
            this.bindEvents(),
        ...
        (e &&
            ...
            R(o, (a) => {
                const r = a.options,
                    ...
                    h = D(r.type, a.dtype);
                ((r.position === void 0 ||
                    js(r.position, c) !== js(a.dposition)) &&
    ...
    buildOrUpdateControllers() {
        ...
        for (
            ...
            if (
                ...
                (a.type = r),
                (a.indexAxis = o.indexAxis || wi(r, this.options)),
                (a.order = o.order || 0),
                (a.index = s),
                (a.label = "" + o.label),
    ...
    _checkEventBindings() {
        const t = this.options,
            ...
            s = new Set(t.events);
        (!ss(e, s) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _getUniformDataChanges() {
        ...
        const e = this.data.datasets.length,
            ...
            n = s(0);
        for (let o = 1; o < e; o++) if (!ss(n, s(o))) return;
        return Array.from(n)
            .map((o) => o.split(","))
    ...
    getContext() {
        return (
            this.$context ||
            (this.$context = St(null, { chart: this, type: "chart" }))
        );
    }
...
function Yl(i, t, e, s) {
    const n = $l(i.options.borderRadius),
        o = (e - t) / 2,
        a = Math.min(o, (s * t) / 2),
        r = (l) => {
...
function Je(i, t, e, s, n, o) {
    ...
    const p = Math.max(0.001, g * d - e / z) / d,
        m = (g - p) / 2,
        b = l + m + f,
        x = n - m - f,
        {
    ...
    if ((i.beginPath(), o)) {
        ...
        if (
            (i.arc(a, r, u, x - k / u, H, !0),
            i.arc(a, r, u, H, b + _ / u, !0),
            _ > 0)
        ) {
            const U = jt(O, X, a, r);
        ...
        i.moveTo(a, r);
        const E = Math.cos(P) * d + a,
            B = Math.sin(P) * d + r;
        i.lineTo(E, B);
        const H = Math.cos(C) * d + a,
            st = Math.sin(C) * d + r;
        i.lineTo(H, st);
    }
    i.closePath();
...
function Ul(i, t, e, s, n) {
    ...
    (f && jl(i, t, g), o || (Je(i, t, e, s, g, n), i.stroke()));
}
class ne extends at {
    constructor(e) {
        super();
    ...
    inRange(e, s, n) {
        const o = this.getProps(["x", "y"], n),
            { angle: a, distance: r } = Dn(o, { x: e, y: s }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
    ...
    draw(e) {
        ...
        if (
            ...
            (this.fullCircles = n > I ? Math.floor(n / I) : 0),
        ...
        const c = 1 - Math.sin(Math.min(z, n || 0)),
            h = o * c;
...
(M(ne, "id", "arc"),
    ...
    M(ne, "defaultRoutes", { backgroundColor: "backgroundColor" }),
    M(ne, "descriptors", {
        _scriptable: !0,
...
function Gl(i, t, e, s) {
    const { points: n, options: o } = t,
        { count: a, start: r, loop: l, ilen: c } = lo(n, e, s),
        h = ql(o);
...
function Zl(i, t, e, s) {
    const n = t.points,
        { count: o, start: a, ilen: r } = lo(n, e, s),
...
function ic(i, t, e, s) {
    ec && !t.options.segment ? Ql(i, t, e, s) : tc(i, t, e, s);
}
class yt extends at {
    constructor(t) {
        (super(),
    ...
    updateControlPoints(t, e) {
        ...
        if (
            ...
            (ja(this._points, s, t, n, e), (this._pointsUpdated = !0));
        }
    }
    set points(t) {
        ((this._points = t),
    ...
    get segments() {
        return (
            this._segments || (this._segments = nr(this, this.options.segment))
        );
    }
    first() {
    ...
    interpolate(t, e) {
        const s = this.options,
            n = t[e],
            o = this.points,
            a = Un(this, { property: e, start: n, end: n });
        if (!a.length) return;
        const r = [],
            l = Jl(s);
        let c, h;
    ...
    draw(t, e, s, n) {
        ...
        ((this.points || []).length &&
            o.borderWidth &&
            (t.save(), ic(t, this, s, n), t.restore()),
            this.animated &&
...
class $e extends at {
    ...
    draw(e, s) {
        ...
        this.skip ||
            n.radius < 0.1 ||
            !bt(this, s, this.size(n) / 2) ||
            ((e.strokeStyle = n.borderColor),
            (e.lineWidth = n.borderWidth),
            (e.fillStyle = n.backgroundColor),
            Mi(e, n, this.x, this.y));
    }
    getRange() {
...
const Di = [
    ...
    qs = Di.map((i) => i.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function ho(i) {
...
function gc() {
    return (
        W.borderColor !== "rgba(0,0,0,0.1)" ||
        W.backgroundColor !== "rgba(0,0,0,0.1)"
    );
}
var pc = {
    id: "colors",
...
function xc(i, t) {
    ...
    return (
        l && (s = Y(mt(t, o.axis, a).lo, 0, e - 1)),
        c ? (n = Y(mt(t, o.axis, r).hi + 1, s, e) - s) : (n = e - s),
        { start: s, count: n }
    );
}
var _c = {
...
function yc(i, t, e) {
    ...
    for (const r of s) {
        ...
        const d = Un(t, h);
        for (const u of d) {
            const f = Ci(e, o[u.start], o[u.end], u.loop),
                g = Xn(r, n, f);
            for (const p of g)
                a.push({
                    source: p,
                    target: u,
                    start: { [e]: Js(h, f, "start", Math.max) },
                    end: { [e]: Js(h, f, "end", Math.min) },
                });
        }
    }
    return a;
...
function Cc(i) {
    const { scale: t, index: e, line: s } = i,
        ...
        a = s.points,
        r = Oc(t, e);
    r.push(go({ x: null, y: t.bottom }, s));
    for (let l = 0; l < o.length; l++) {
        const c = o[l];
        for (let h = c.start; h <= c.end; h++) Ac(n, a[h], r);
    }
    return new yt({ points: n, options: {} });
}
function Oc(i, t) {
    const e = [],
...
function Ac(i, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
        const o = e[n],
            { first: a, last: r, point: l } = Tc(o, t, "x");
        if (!(!l || (a && r))) {
            if (a) s.unshift(l);
...
function Lc(i) {
    ...
    if (N(e)) return Rc(t, e);
    if (e === "stack") return Cc(i);
    if (e === "shape") return !0;
    const n = Ec(i);
...
function Ec(i) {
    return (i.scale || {}).getPointPositionForValue ? Ic(i) : Fc(i);
}
function Fc(i) {
...
function zc(i, t) {
    ...
    (i.save(),
        c === "x" &&
            ...
            i.save(),
            tn(i, s, a.bottom)),
        en(i, { line: e, target: s, color: o, scale: r, property: c, clip: l }),
        i.restore());
}
function tn(i, t, e) {
...
var Vc = {
    ...
    afterDatasetsUpdate(i, t, e) {
        ...
        for (a = 0; a < s; ++a)
            ((l = n[a]),
                !(!l || l.fill === !1) && (l.fill = Mc(n, a, e.propagate)));
    },
    beforeDraw(i, t, e) {
...
class on extends at {
    ...
    fit() {
        ...
        const s = t.labels,
            ...
            { boxWidth: r, itemHeight: l } = nn(s, o);
        let c, h;
        ((e.font = n.string),
            this.isHorizontal()
    ...
    _fitCols(t, e, s, n) {
        ...
        return (
            this.legendItems.forEach((m, b) => {
                const { itemWidth: x, itemHeight: v } = Nc(s, e, o, m, n);
                (b > 0 &&
                    f + v + 2 * r > h &&
                    ((d += u + r),
    ...
    _draw() {
        const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
            { align: o, labels: a } = t,
            r = W.color,
            l = $t(t.rtl, this.left, this.width),
            c = $(a.font),
            { padding: h } = a,
            d = c.size,
            u = d / 2;
        ...
        (this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = c.string));
        const { boxWidth: g, boxHeight: p, itemHeight: m } = nn(a, d),
            b = function (k, w, S) {
                ...
                if (
                    ...
                    const C = w + Math.max((d - p) / 2, 0),
                        O = l.leftForLtr(k, g),
                        L = Ft(S.borderRadius);
                    (n.beginPath(),
                        Object.values(L).some((X) => X !== 0)
                            ? me(n, { x: O, y: C, w: g, h: p, radius: L })
                            : n.rect(O, C, g, p),
                        n.fill(),
                        P !== 0 && n.stroke());
                }
        ...
        (this.legendItems.forEach((k, w) => {
            ...
            (l.setWidth(this.width),
                v
                    ? w > 0 &&
                      ...
                      ((L = f.y += _),
                      f.line++,
                      (O = f.x = K(o, this.left + h, this.right - s[f.line])))
                    : w > 0 &&
                      L + _ > this.bottom &&
            ...
            if (
                (b(X, L, k),
                (O = ra(P, O + g + u, v ? O + C : this.right, t.rtl)),
                x(l.x(O), L, k),
                v)
            )
                f.x += C + h;
    ...
    drawTitle() {
        const t = this.options,
            ...
            n = G(e.padding);
        if (!e.display) return;
        const o = $t(t.rtl, this.left, this.width),
            a = this.ctx,
            r = e.position,
            l = s.size / 2,
            c = n.top + l;
    ...
    _getLegendItemAt(t, e) {
        ...
        if (pt(t, this.left, this.right) && pt(e, this.top, this.bottom)) {
            for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
                if (
                    ((n = o[s]),
                    pt(t, n.left, n.left + n.width) &&
                        pt(e, n.top, n.top + n.height))
                )
...
var Yc = {
    ...
    _element: on,
    start(i, t, e) {
        const s = (i.legend = new on({ ctx: i.ctx, options: e, chart: i }));
    ...
    _drawArgs(t) {
        ...
        return (
            this.isHorizontal()
                ...
                : (a.position === "left"
                      ? ((h = s + t), (d = K(r, n, e)), (l = z * -0.5))
                      : ((h = o - t), (d = K(r, e, n)), (l = z * 0.5)),
                  (c = n - e)),
...
function an(i, t) {
    ...
    return (
        ...
        R(i.title, v),
        (e.font = l.string),
        R(i.beforeBody.concat(i.afterBody), v),
...
function rn(i, t, e) {
    ...
    return { xAlign: e.xAlign || t.xAlign || Jc(i, t, e, s), yAlign: s };
}
function Qc(i, t) {
    let { x: e, width: s } = i;
...
function ln(i, t, e, s) {
    const { caretSize: n, caretPadding: o, cornerRadius: a } = i,
        { xAlign: r, yAlign: l } = e,
        c = n + o,
        { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Ft(a);
    let g = Qc(t, r);
    const p = th(t, l, c);
    return (
        l === "center"
...
function eh(i, t, e) {
    return St(i, { tooltip: t, tooltipItems: e, type: "tooltip" });
}
function hn(i, t) {
    const e =
...
class Oi extends at {
    ...
    getTitle(t, e) {
        const { callbacks: s } = e,
            n = Z(s, "beforeTitle", this, t),
            o = Z(s, "title", this, t),
            a = Z(s, "afterTitle", this, t);
        let r = [];
        return ((r = rt(r, ft(n))), (r = rt(r, ft(o))), (r = rt(r, ft(a))), r);
    }
    getBeforeBody(t, e) {
        ...
        return (
            R(t, (o) => {
                const a = { before: [], lines: [], after: [] },
                    r = hn(s, o);
                (rt(a.before, ft(Z(r, "beforeLabel", this, o))),
                    rt(a.lines, Z(r, "label", this, o)),
                    rt(a.after, ft(Z(r, "afterLabel", this, o))),
                    n.push(a));
            }),
            n
        );
    ...
    getFooter(t, e) {
        const { callbacks: s } = e,
            n = Z(s, "beforeFooter", this, t),
            o = Z(s, "footer", this, t),
            a = Z(s, "afterFooter", this, t);
        let r = [];
        return ((r = rt(r, ft(n))), (r = rt(r, ft(o))), (r = rt(r, ft(a))), r);
    }
    _createItems(t) {
        ...
        return (
            ...
            R(r, (h) => {
                ...
                (n.push(Z(d, "labelColor", this, h)),
                    o.push(Z(d, "labelPointStyle", this, h)),
                    a.push(Z(d, "labelTextColor", this, h)));
            }),
            (this.labelColors = n),
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            const l = (this._size = an(this, s)),
                c = Object.assign({}, r, l),
                h = rn(this.chart, s, c),
                d = ln(s, c, h, this.chart);
    ...
    getCaretPosition(t, e, s) {
        const { xAlign: n, yAlign: o } = this,
            ...
            { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Ft(r),
            { x: u, y: f } = t,
            { width: g, height: p } = e;
        let m, b, x, v, y, _;
        return (
    ...
    _drawColorBox(t, e, s, n, o) {
        ...
        if (o.usePointStyle) {
            ...
            Object.values(b).some((x) => x !== 0)
                ? (t.beginPath(),
                  (t.fillStyle = o.multiKeyBackground),
                  me(t, { x: p, y: g, w: c, h: l, radius: b }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = a.backgroundColor),
                  t.beginPath(),
                  me(t, { x: m, y: g + 1, w: c - 2, h: l - 2, radius: b }),
                  t.fill())
                : ((t.fillStyle = o.multiKeyBackground),
                  t.fillRect(p, g, c, l),
    ...
    drawBody(t, e, s) {
        ...
        let u = d.lineHeight,
            f = 0;
        const g = $t(s.rtl, this.x, this.width),
            p = function (S) {
    ...
    _updateAnimationTarget(t) {
        const e = this.chart,
            ...
            o = s && s.y;
        if (n || o) {
            const a = oe[t.position].call(
                this,
                this._active,
                this._eventPosition,
            );
            if (!a) return;
            const r = (this._size = an(this, t)),
...
var ih = {
        ...
        positioners: oe,
        afterInit(i, t, e) {
            e && (i.tooltip = new Oi({ chart: i, options: e }));
        },
        beforeUpdate(i, t, e) {
...
function oh(i, t, e, s) {
    const n = i.indexOf(t);
    if (n === -1) return nh(i, t, e, s);
    const o = i.lastIndexOf(t);
    return n !== o ? e : n;
}
const ah = (i, t) => (i === null ? null : Y(Math.round(i), 0, t));
function dn(i) {
    ...
    parse(t, e) {
        ...
        return (
            (e =
                isFinite(e) && s[e] === t
                    ? e
                    : oh(s, t, D(e, t), this._addedLabels)),
            ah(e, s.length - 1)
        );
    }
    determineDataLimits() {
...
(M(Ai, "id", "category"), M(Ai, "defaults", { ticks: { callback: dn } }));
function rh(i, t) {
    const e = [],
        {
            bounds: n,
    ...
    for (
        ...
        (u && w !== a
            ? (e.push({ value: a }),
              w < a && O++,
              le(Math.round((w + O * _) * k) / k, a, un(a, y, i)) && O++)
            : w < a && O++);
        O < P;
        ++O
    ) {
    ...
    return (
        x && u && S !== r
            ? e.length && le(e[e.length - 1].value, r, un(r, y, i))
...
class Qe extends Vt {
    ...
    buildTicks() {
        ...
        const n = {
            ...
            a = rh(n, o);
        return (
            t.bounds === "ticks" && Pn(a, this, "value"),
            t.reverse
...
(M(Ti, "id", "linear"),
    M(Ti, "defaults", { ticks: { callback: ti.formatters.numeric } }));
const xe = (i) => Math.floor(_t(i)),
    Tt = (i, t) => Math.pow(10, xe(i) + t);
function fn(i) {
...
function ch(i, { min: t, max: e }) {
    ...
    let d = Math.floor((c - h) / Math.pow(10, o)),
        u = tt(i.min, Math.round((l + h + d * Math.pow(10, o)) * a) / a);
    for (; u < e; )
        (s.push({ value: u, major: fn(u), significand: d }),
            d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
            d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
            (u = Math.round((l + h + d * Math.pow(10, o)) * a) / a));
    const f = tt(i.max, u);
    return (s.push({ value: f, major: fn(f), significand: d }), s);
}
class Li extends Vt {
    constructor(t) {
        (super(t),
    ...
    parse(t, e) {
        const s = Qe.prototype.parse.apply(this, [t, e]);
        if (s === 0) {
            this._zero = !0;
            return;
        }
    ...
    determineDataLimits() {
        ...
        ((this.min = N(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
                ...
                !N(this._userMin) &&
                (this.min =
                    t === Tt(this.min, 0) ? Tt(this.min, -1) : Tt(this.min, 0)),
            this.handleTickRangeOptions());
    }
    handleTickRangeOptions() {
        const { minDefined: t, maxDefined: e } = this.getUserBounds();
        ...
        const o = (r) => (s = t ? s : r),
            a = (r) => (n = e ? n : r);
        (s === n && (s <= 0 ? (o(1), a(10)) : (o(Tt(s, -1)), a(Tt(n, 1)))),
            s <= 0 && o(Tt(n, -1)),
            n <= 0 && a(Tt(s, 1)),
            (this.min = s),
            (this.max = n));
    ...
    buildTicks() {
        const t = this.options,
            ...
            s = ch(e, this);
        return (
            t.bounds === "ticks" && Pn(s, this, "value"),
            t.reverse
...
function hh(i, t, e) {
    return (
        (e = V(e) ? e : [e]),
        { w: ba(i, t.string, e), h: e.length * t.lineHeight }
    );
}
...
function dh(i) {
    ...
    for (let l = 0; l < o; l++) {
        ...
        const h = i.getPointPosition(l, i.drawingArea + n[l], r),
            d = $(c.font),
            u = hh(i.ctx, d, i._pointLabels[l]);
        s[l] = u;
        const f = et(i.getIndexAngle(l) + r),
            g = Math.round(Vi(f)),
            p = pn(g, h.x, u.w, 0, 180),
            m = pn(g, h.y, u.h, 90, 270);
        uh(e, t, f, p, m);
    }
    (i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
        (i._pointLabelItems = ph(i, s, n)));
}
...
function ph(i, t, e) {
    const s = [],
        ...
        l = { extra: Ri(o) / 2, additionalAngle: a ? z / n : 0 };
    let c;
    for (let h = 0; h < n; h++) {
        ((l.padding = e[h]), (l.size = t[h]));
        const d = fh(i, h, l);
        (s.push(d),
            r === "auto" && ((d.visible = gh(d, c)), d.visible && (c = d)));
    }
    return s;
}
function mh(i) {
...
function Mh(i, t, e) {
    return St(i, { label: e, index: t, type: "pointLabel" });
}
class ae extends Qe {
    constructor(t) {
        (super(t),
    ...
    setDimensions() {
        const t = (this._padding = G(Ri(this.options) / 2)),
    ...
    drawGrid() {
        ...
        let r, l, c;
        if (
            (e.pointLabels.display && yh(this, a),
            n.display &&
...
(M(ae, "id", "radialLinear"),
    ...
    M(ae, "descriptors", { angleLines: { _fallback: "grid" } }));
const oi = {
...
function wh(i) {
    for (let t = J.indexOf(i) + 1, e = J.length; t < e; ++t)
        if (oi[J[t]].common) return J[t];
}
function _n(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
        const { lo: s, hi: n } = Wi(e, t),
            o = e[s] >= t ? e[s] : e[n];
        i[o] = !0;
    }
}
...
class _e extends Vt {
        ...
        return (
            (this._unit =
                ...
                (s.autoSkip
                    ...
                    : kh(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
    ...
    _generate() {
        const t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            a = o.unit || xn(o.minUnit, e, s, this._getLabelCapacity(e)),
        ...
        for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) _n(h, u, g);
        return (
            (u === s || n.bounds === "ticks" || f === 1) && _n(h, u, g),
            Object.keys(h)
                .sort(mn)
                .map((p) => +p)
        );
    ...
    getLabelTimestamps() {
        ...
        for (e = 0, s = n.length; e < s; ++e) t.push(bn(this, n[e]));
...
class Ei extends _e {
    ...
    initOffsets() {
        ...
        ((this._minPos = Ie(e, this.min)),
            (this._tableRange = Ie(e, this.max) - this._minPos),
            super.initOffsets(t));
    }
    buildLookupTable(t) {
...
const Dh = [Rr, lc, sh, Ph];
ct.register(...Dh);
document.addEventListener("DOMContentLoaded", () => {
    const i = document.getElementById("energyChart");
    i &&
        new ct(i, {
            type: "line",
            data: {
            ...
            options: {
                ...
                scales: {
                    y: { beginAtZero: !0, title: { display: !0, text: "kWh" } },
                    x: { title: { display: !0, text: "Month" } },
                },
                plugins: {
                    legend: {
                        display: !0,
