...
function Y(s) {
    let { overflow: t, overflowX: e, overflowY: i, display: n } = C(s);
...
function B(s) {
    ...
    let t = s.assignedSlot || s.parentNode || (Tt(s) && s.host) || T(s);
    ...
    if (o) {
        ...
        for (; m && i && f !== u; ) {
            let g = Q(m),
                ...
                L = w.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (h *= g.x),
                (d *= g.y),
...
function be(s) {
    let t = T(s),
        ...
        n = H(t.scrollWidth, t.clientWidth, i.scrollWidth, i.clientWidth),
        o = H(t.scrollHeight, t.clientHeight, i.scrollHeight, i.clientHeight),
        r = -e.scrollLeft + pt(s),
        l = -e.scrollTop;
    return (
    ...
    if (c <= 0) {
        let h = i.ownerDocument,
            ...
            f =
                ...
                0,
            u = Math.abs(i.clientWidth - d.clientWidth - f);
        u <= Ft && (o -= u);
    } else c <= Ft && (o += c);
