        ...
        n === void 0 && (n = {}),
        {
            ...
            async fn(t) {
                ...
                if (
                    ...
                    let P =
                        (tt = V.filter(($) => $.overflows[0] <= 0).sort(
                            ($, B) => $.overflows[1] - B.overflows[1],
                        )[0]) == null
                            ? void 0
                            : tt.placement;
                    if (!P)
...
function vi(n, t) {
    let e = ut(n);
    return e === t || !et(e) || Dt(e)
        ? !1
        : it(e).position === "fixed" || vi(e, t);
}
function wn(n, t) {
    let e = t.get(n);
    if (e) return e;
    let i = ie(n, [], !1).filter((a) => et(a) && Ot(a) !== "body"),
        o = null,
        s = it(n).position === "fixed",
        r = s ? ut(n) : n;
    for (; et(r) && !Dt(r); ) {
        let a = it(r),
            l = oe(r);
...
var h,
    ...
    Hn = xe && !Pi && !Xe && "draggable" in document.createElement("div"),
    Wi = (function () {
        if (xe) {
            if (mt) return !1;
...
v.prototype = {
    ...
    _onDragStart: function (t, e) {
        ...
        (G("setupClone", this),
            v.eventCanceled ||
                ...
                (I.style["will-change"] = ""),
                this._hideClone(),
                Q(I, this.options.chosenClass, !1),
                (v.clone = I)),
            (i.cloneId = ge(function () {
                (G("clone", i),
                    !v.eventCanceled &&
                        (i.options.removeCloneOnHide || L.insertBefore(I, h),
                        i._hideClone(),
        ...
        if (
            ...
            if (r)
                return (
                    ...
                    S("revert"),
                    v.eventCanceled ||
                        (Lt ? L.insertBefore(h, Lt) : L.appendChild(h)),
                    w(!0)
                );
            ...
            if (!A || ($n(t, u, this) && !A.animated)) {
                ...
                var C = kt(e, 0, a, !0);
                if (C === h) return w(!1);
                if (((i = C), (s = N(i)), fe(L, e, h, o, i, s, t, !1) !== !1))
                    return (O(), e.insertBefore(h, C), (_ = e), D(), w(!0));
                ...
                var F = 0,
                    ...
                    V = u ? "top" : "left",
                    X = Ci(i, "top", "top") || Ci(h, "top", "top"),
                    tt = X ? X.scrollTop : void 0;
                (Rt !== i &&
                    ((q = s[V]), (Qt = !1), (ce = (!T && a.invertSwap) || J)),
                    (F = Un(
                        t,
                        i,
                        s,
                ...
                if ($ !== !1)
                    return (
                        ...
                        P && !Y
                            ? e.appendChild(h)
                            : i.parentNode.insertBefore(h, P ? Y : i),
                        X && Fi(X, 0, tt - X.scrollTop),
                        (_ = h.parentNode),
                        q !== void 0 && !ce && (pe = Math.abs(q - N(i)[V])),
                        D(),
                        w(!0)
                    );
            }
    ...
    _showClone: function (t) {
        ...
        if (St) {
            ...
            (h.parentNode == L && !this.options.group.revertClone
                ? L.insertBefore(I, h)
                : Lt
                  ? L.insertBefore(I, Lt)
                  : L.appendChild(I),
                this.options.group.revertClone && this.animate(h, I),
                b(I, "display", ""),
                (St = !1));
        }
    },
        ...
        if (t.scroll) {
            ...
            do {
                ...
                var tt =
                    ...
                    W =
                        F &&
                        (Math.abs(S - s) <= r && X + A < J) -
                            (Math.abs(m - s) <= r && !!X);
                if (!M[d]) for (var k = 0; k <= d; k++) M[k] || (M[k] = {});
                ((M[d].vx != tt || M[d].vy != W || M[d].el !== u) &&
                    ((M[d].el = u),
                    (M[d].vx = tt),
                    (M[d].vy = W),
...
var Ee = class {
    constructor({
        ...
        ((this.element = t),
            ...
            (this.hasDynamicOptions = A),
            (this.hasDynamicSearchResults = C),
            (this.searchPrompt = F),
            (this.searchDebounce = q),
            (this.loadingMessage = J),
            (this.searchingMessage = T),
            (this.noSearchResultsMessage = V),
            (this.activeSearchId = 0),
            (this.maxItems = X),
            (this.maxItemsMessage = tt),
            (this.optionsLimit = W),
            (this.position = k),
