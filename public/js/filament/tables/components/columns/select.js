...
function Ze(n, t, e, i) {
    let o = Wt(n),
        s = tn(yt(n), e === "start", i);
    return (
        o && ((s = s.map((r) => r + "-" + o)), t && (s = s.concat(s.map(ee)))),
        s
    );
}
function Bt(n) {
...
async function Le(n, t) {
    ...
    let { x: i, y: o, platform: s, rects: r, elements: a, strategy: l } = n,
        ...
        C = (await (s.isElement == null ? void 0 : s.isElement(D)))
        ...
        n === void 0 && (n = {}),
        {
            ...
            async fn(t) {
                ...
                let j = [a, ...L],
                    q = await Le(t, S),
                    A = [],
                    B = ((i = s.flip) == null ? void 0 : i.overflows) || [];
                if ((f && A.push(q[O]), d)) {
                    let F = Je(o, r, C);
                    A.push(q[F[0]], q[F[1]]);
                }
                if (
                    ((B = [...B, { placement: o, overflows: A }]),
                    !A.every((F) => F <= 0))
                ) {
                    var V, nt;
                    let F =
                    ...
                    if (
                        J &&
                        (!(d === "alignment" ? w !== ht(J) : !1) ||
                            B.every((k) =>
                                ht(k.placement) === w ? k.overflows[0] > 0 : !0,
                            ))
                    )
                        return {
                            data: { index: F, overflows: B },
                            reset: { placement: J },
                        };
                    let P =
                        (nt = B.filter((K) => K.overflows[0] <= 0).sort(
                            (K, k) => K.overflows[1] - k.overflows[1],
                        )[0]) == null
                            ? void 0
                            : nt.placement;
                    if (!P)
                                ...
                                let K =
                                    ($ = B.filter((k) => {
                                        ...
                                        .map((k) => [
                                            ...
                                            k.overflows
                                                .filter((lt) => lt > 0)
                                                .reduce((lt, Ue) => lt + Ue, 0),
                                        ])
                                        .sort((k, lt) => k[1] - lt[1])[0]) ==
                                    null
                                        ? void 0
                                        : $[0];
                                K && (P = K);
...
function st(n) {
    return ne()
        ? n instanceof HTMLElement || n instanceof Y(n).HTMLElement
        : !1;
}
function ri(n) {
    return !ne() || typeof ShadowRoot > "u"
        ? !1
        : n instanceof ShadowRoot || n instanceof Y(n).ShadowRoot;
}
...
function vi(n, t) {
    let e = ut(n);
    return e === t || !tt(e) || Dt(e)
        ? !1
        : et(e).position === "fixed" || vi(e, t);
}
function wn(n, t) {
    let e = t.get(n);
    if (e) return e;
    let i = ie(n, [], !1).filter((a) => tt(a) && Ot(a) !== "body"),
        o = null,
        s = et(n).position === "fixed",
        r = s ? ut(n) : n;
    for (; tt(r) && !Dt(r); ) {
        let a = et(r),
            l = oe(r);
...
function Xe(n, t) {
    for (
        ...
        e && (e === v.ghost || b(e, "display") === "none" || (t && !be(e, t)));
    )
...
var h,
    ...
    Hn = xe && !Pi && !$e && "draggable" in document.createElement("div"),
    Wi = (function () {
        if (xe) {
            if (mt) return !1;
...
v.prototype = {
    ...
    _appendGhost: function () {
        if (!y) {
            ...
            ((y = h.cloneNode(!0)),
                ...
                b(y, "height", e.height),
                b(y, "opacity", "0.8"),
                b(y, "position", de ? "absolute" : "fixed"),
                b(y, "zIndex", "100000"),
    ...
    _onDragStart: function (t, e) {
        ...
        (U("setupClone", this),
            v.eventCanceled ||
                ...
                (v.clone = T)),
            (i.cloneId = ge(function () {
                (U("clone", i),
                    !v.eventCanceled &&
                        (i.options.removeCloneOnHide || I.insertBefore(T, h),
                        i._hideClone(),
                        X({ sortable: i, name: "clone" })));
            })),
            !e && Q(h, s.dragClass, !0),
            e
                ? ((ve = !0), (i._loopId = setInterval(i._emulateDragOver, 50)))
            ...
            (Pt = !0),
            (i._dragStartId = ge(i._dragStarted.bind(i, e, t))),
    ...
    _onDragOver: function (t) {
        ...
        function w(k) {
            return (
                S("dragOverCompleted", { insertion: k }),
                k &&
                ...
                !a.dragoverBubble &&
                    !t.rootEl &&
                    i !== document &&
                    (h.parentNode[G]._isOutsideThisEl(t.target), !k && Ct(t)),
        ...
        if (
            ...
            c &&
                ...
                (f
                    ? d || (r = _ !== I)
                    : W === this ||
                      ((this.lastPutMode = le.checkPull(this, c, h, t)) &&
            ...
            if (!C || (Yn(t, u, this) && !C.animated)) {
                ...
                var L = kt(e, 0, a, !0);
                if (L === h) return w(!1);
                if (((i = L), (s = N(i)), fe(I, e, h, o, i, s, t, !1) !== !1))
                    return (O(), e.insertBefore(h, L), (_ = e), D(), w(!0));
                ...
                var H = 0,
                    ...
                    B = u ? "top" : "left",
                    V = Ci(i, "top", "top") || Ci(h, "top", "top"),
                    nt = V ? V.scrollTop : void 0;
                (Rt !== i &&
                    ((j = s[B]), (Qt = !1), (ce = (!A && a.invertSwap) || q)),
                    (H = Un(
                        t,
                        i,
                        s,
                ...
                if (K !== !1)
                    return (
                        ...
                        P && !J
                            ? e.appendChild(h)
                            : i.parentNode.insertBefore(h, P ? J : i),
                        V && Fi(V, 0, nt - V.scrollTop),
                        (_ = h.parentNode),
                        j !== void 0 && !ce && (pe = Math.abs(j - N(i)[B])),
                        D(),
                        w(!0)
                    );
            }
...
function Yn(n, t, e) {
    var i = N(Xe(e.el, e.options.draggable)),
        o = Vi(e.el, e.options, y),
        s = 10;
    return t
        ? n.clientX > o.right + s ||
    ...
    if (!r) {
        if (a && pe < c * o) {
            if (
                ...
                p = !0;
            else if (Jt === 1 ? l < f + pe : l > d - pe) return -Jt;
...
var Fe = Bi(function (n, t, e, i) {
        if (t.scroll) {
            ...
            do {
                ...
                var nt =
                        L &&
                        (Math.abs(w - o) <= r && B + D < j) -
                            (Math.abs(O - o) <= r && !!B),
                    $ =
                        H &&
                        (Math.abs(S - s) <= r && V + C < q) -
                            (Math.abs(m - s) <= r && !!V);
                if (!M[d]) for (var F = 0; F <= d; F++) M[F] || (M[F] = {});
                ((M[d].vx != nt || M[d].vy != $ || M[d].el !== u) &&
                    ((M[d].el = u),
                    (M[d].vx = nt),
                    (M[d].vy = $),
                    ...
                    (nt != 0 || $ != 0) &&
                        ...
                        (M[d].pid = setInterval(
                            function () {
                                i &&
                                    this.layer === 0 &&
                                    v.active._onTouchMove(Se);
                                var J = M[this.layer].vy
                                        ? M[this.layer].vy * a
                                        : 0,
                                    P = M[this.layer].vx
                                        ? M[this.layer].vx * a
...
var Ee = class {
    constructor({
        ...
        ((this.element = t),
            ...
            (this.placeholder = i),
            (this.state = o),
            (this.canOptionLabelsWrap = s),
            (this.canSelectPlaceholder = r),
            (this.initialOptionLabel = a),
            (this.initialOptionLabels = l),
            (this.initialState = c),
            (this.isHtmlAllowed = f),
            (this.isAutofocused = d),
            (this.isDisabled = p),
            (this.isMultiple = u),
            (this.isReorderable = g),
            (this.isSearchable = m),
            (this.getOptionLabelUsing = S),
            (this.getOptionLabelsUsing = O),
            (this.getOptionsUsing = w),
            (this.getSearchResultsUsing = D),
            (this.hasDynamicOptions = C),
            (this.hasDynamicSearchResults = L),
            (this.searchPrompt = H),
            (this.searchDebounce = j),
            (this.loadingMessage = q),
            (this.searchingMessage = A),
            (this.noSearchResultsMessage = B),
            (this.activeSearchId = 0),
            (this.maxItems = V),
            (this.maxItemsMessage = nt),
            (this.optionsLimit = $),
            (this.position = F),
            (this.searchableOptionFields = Array.isArray(J) ? J : ["label"]),
            (this.livewireId = P),
            (this.statePath = K),
            (this.onStateChange = k),
    ...
    createBadgeElement(t, e) {
        ...
        ((i.className =
            ...
            R(t) && i.setAttribute("data-value", t));
        let o = document.createElement("span");
    ...
    async getLabelForSingleSelection() {
        ...
        if (
            ...
            bt(t) &&
                R(this.initialOptionLabel) &&
                this.state === this.initialState)
        )
            ((t = this.initialOptionLabel),
                R(this.state) && (this.labelRepository[this.state] = t));
