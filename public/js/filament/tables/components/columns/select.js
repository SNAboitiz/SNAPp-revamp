...
function U(s) {
    let { x: t, y: e, width: i, height: n } = s;
    return {
        width: i,
        height: n,
        top: e,
...
var Et = async (s, t, e) => {
    let {
        ...
        c = await r.getElementRects({ reference: s, floating: t, strategy: n }),
        { x: h, y: d } = Dt(c, i, a),
        u = i,
        f = {},
        p = 0;
...
async function wt(s, t) {
    var e;
    t === void 0 && (t = {});
    let { x: i, y: n, platform: o, rects: r, elements: l, strategy: a } = s,
        {
    ...
    return {
        top: (w.top - x.top + p.top) / O.y,
        bottom: (x.bottom - w.bottom + p.bottom) / O.y,
        left: (w.left - x.left + p.left) / O.x,
...
async function oe(s, t) {
    let { placement: e, platform: i, elements: n } = s,
...
var le = new Set(["table", "td", "th"]);
function Mt(s) {
    return le.has(K(s));
}
var ae = [":popover-open", ":modal"];
function nt(s) {
    return ae.some((t) => {
        try {
            return s.matches(t);
...
var ce = ["transform", "translate", "scale", "rotate", "perspective"],
...
var fe = new Set(["html", "body", "#document"]);
function _(s) {
    return fe.has(K(s));
}
function D(s) {
...
function N(s) {
    ...
    let t = s.assignedSlot || s.parentNode || (Tt(s) && s.host) || P(s);
    ...
    if (o) {
        ...
        for (; m && i && f !== p; ) {
            let g = X(m),
                ...
                O = w.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (h *= g.x),
                (d *= g.y),
...
function ut(s, t) {
    let e = ot(s).scrollLeft;
    return t ? t.left + e : rt(P(s)).left + e;
}
function Ut(s, t) {
    let e = s.getBoundingClientRect(),
        i = e.left + t.scrollLeft - ut(s, e),
        n = e.top + t.scrollTop;
    return { x: i, y: n };
}
function me(s) {
    let { elements: t, rect: e, offsetParent: i, strategy: n } = s,
        o = n === "fixed",
        r = P(i),
        l = t ? nt(t.floating) : !1;
    if (i === r || (l && o)) return e;
...
function be(s) {
    let t = P(s),
        ...
        n = $(t.scrollWidth, t.clientWidth, i.scrollWidth, i.clientWidth),
        o = $(t.scrollHeight, t.clientHeight, i.scrollHeight, i.clientHeight),
        r = -e.scrollLeft + ut(s),
        l = -e.scrollTop;
    return (
    ...
    if (c <= 0) {
        let h = i.ownerDocument,
            ...
            f =
                ...
                0,
            p = Math.abs(i.clientWidth - d.clientWidth - f);
        p <= Ft && (o -= p);
    } else c <= Ft && (o += c);
...
function Kt(s, t) {
    ...
    return e === t || !C(e) || _(e)
        ? !1
        : D(e).position === "fixed" || Kt(e, t);
}
function ve(s, t) {
    let e = t.get(s);
    if (e) return e;
    let i = at(s, [], !1).filter((l) => C(l) && K(l) !== "body"),
        n = null,
        o = D(s).position === "fixed",
        r = o ? N(s) : s;
    for (; C(r) && !_(r); ) {
        let l = D(r),
            a = ht(r);
...
function Le(s) {
    let { element: t, boundary: e, rootBoundary: i, strategy: n } = s,
        r = [
            ...(e === "clippingAncestors"
                ? nt(t)
                    ? []
...
function Ht(s, t) {
    if (!T(s) || D(s).position === "fixed") return null;
    if (t) return t(s);
...
var pt = class {
                        ...
                        if (t.key === "Tab") {
                            ...
                            let i = e.find((o) => {
                                let r =
                                        ...
                                        "true",
                                    l = o.classList.contains("fi-disabled"),
                                    a = o.offsetParent === null;
                                return !(r || l || a);
                            });
                            if (!i) return;
    ...
    async updateSelectedDisplay() {
        ...
        if (this.isMultiple) {
            if (!Array.isArray(this.state) || this.state.length === 0) {
                ...
                let n = await this.getLabelsForMultipleSelection();
    ...
    addBadgesForSelectedOptions(t, e = this.selectedDisplay) {
        ...
        ((i.className = "fi-select-input-value-badges-ctn"),
            t.forEach((n, o) => {
                let r = Array.isArray(this.state) ? this.state[o] : null,
                    l = this.createBadgeElement(r, n);
                i.appendChild(l);
            }),
            e.appendChild(i));
    }
    ...
    async addSingleBadge(t, e) {
        ...
        F(i) && (i = t);
        let n = this.createBadgeElement(t, i);
        e.appendChild(n);
    }
